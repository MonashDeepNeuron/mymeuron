...
def missed_preprocessing(csv_path: str = "paintrainingdata.csv") -> pd.DataFrame:
    """
    columns:
        x = [
        "age",
        "gender",  # X: patient info
        "temperature",
        "heartrate",
        "resprate",
        "o2sat",
...
def load_data(df: pd.DataFrame):
    ...
    # convert to pytorch array first
    X = df[
        [
            "age",
            "gender",
...
def main() -> None:
    ...
    df = missed_preprocessing("paintrainingdata.csv")
